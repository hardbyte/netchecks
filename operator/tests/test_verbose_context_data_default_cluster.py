...
def test_output_unredacted_context_data(netchecks, k8s_namespace, test_file_path):
    manifest = test_file_path("with-verbose-context.yaml")
    ...
    assertion_name = "http-with-verbose-context"
